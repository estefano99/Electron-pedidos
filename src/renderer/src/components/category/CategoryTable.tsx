...
export function CategoryTable({ categories, isActive, setIsActive }: props) {
    ...
    <div className="w-11/12 mx-auto">
      <div className="grid grid-cols-2 md:grid-cols-4 items-center py-4 gap-5">
        ...
        <div className="flex items-center space-x-2">
          <Switch id="activos" checked={isActive} onCheckedChange={setIsActive} />
          <Label htmlFor="activos">{isActive ? 'Activos' : 'Inactivos'}</Label>
        </div>
        <DropdownMenu>
