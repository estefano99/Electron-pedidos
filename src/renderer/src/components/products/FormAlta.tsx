...
const FormAlta = () => {
  ...
  const handleChangeFile = (e: React.ChangeEvent<HTMLInputElement>, onChange: (file: File | undefined) => void) => {
    ...
    <AlertDialog onOpenChange={setOpen} open={open}>
      <AlertDialogTrigger asChild className="h-8.5 2xl:h-10">
        <Button className="flex gap-2 text-xs 2xl:text-sm" >
          <Pizza className="h-4 w-4 2xl:h-5 2xl:w-5" />
